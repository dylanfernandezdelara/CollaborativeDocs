...
function DocumentVignette() {
  return (
    <div className="rounded-[10px] border border-border bg-page px-4 py-3.5">
      ...
      <p className="mt-3 text-[11px] tracking-[-0.15px] text-ink-tertiary">
        A, B · 2 editing now
      </p>
    </div>
  );
  ...
  return (
    <main className="grid min-h-screen md:grid-cols-[1.1fr_1fr]">
      <aside className="hidden flex-col justify-between border-r border-border bg-page-elevated/70 px-8 py-8 md:flex lg:px-12">
        <Link href="/" className="w-fit text-[13px] font-medium tracking-[-0.15px] text-ink">
          Docs
        </Link>
        <div className="max-w-[300px]">
          <DocumentVignette />
          <p className="mt-4 text-[13px] leading-5 tracking-[-0.15px] text-ink-secondary">
      ...
      <section className="flex flex-col justify-center px-6 py-12 sm:px-10 lg:px-16">
        <div className="mx-auto w-full max-w-[320px] md:mx-0">
          <Link
            href="/"
            className="mb-10 block w-fit text-[13px] font-medium tracking-[-0.15px] text-ink md:hidden"
          >
            Docs
          </Link>
          <h1 className="text-[21px] font-medium tracking-[-0.15px] text-ink">
            Sign in
          </h1>
          <p className="mt-2 text-[13px] tracking-[-0.15px] text-ink-tertiary">
