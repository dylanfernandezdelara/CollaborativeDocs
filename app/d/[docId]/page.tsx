...
export default function DocPage({
  ...
  return (
    ...
    >
      <header className="pointer-events-none sticky top-4 z-30 flex items-start justify-between px-6 sm:top-6">
        <Link
          href="/"
      ...
      <main className="mx-auto max-w-[640px] px-6 pt-10 pb-20 sm:pt-16 sm:pb-24">
        {sync.isLoading ? (
          <p className="text-[14px] text-ink-tertiary">Loading…</p>
